...
def predict_points(player_name, opposing_team):
    player_info = check_player_trend(player_name)
    ...
    opp_pts = df.loc[df['TEAM_NAME'] == opposing_team, 'OPP_PTS'].iloc[0]
...
if __name__=="__main__":
    print(round(predict_points("Luka Doncic", "New Orleans Pelicans"), 1))